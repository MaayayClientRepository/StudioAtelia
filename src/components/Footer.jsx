...
const Footer = () => {
    ...
    return (
        <footer className="relative bg-base text-secondary pt-6 pb-10 sm:pt-8 sm:pb-14 md:pt-14 md:pb-24 px-4 sm:px-6 md:px-24 rounded-t-[2rem] sm:rounded-t-[3rem] md:rounded-t-[6rem] overflow-hidden flex flex-col justify-start border-t border-white/5 shadow-[0_-20px_40px_rgba(0,0,0,0.5)]">
            {/* Background Branding Typography - ANIMATED & CINEMATIC */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.03] pointer-events-none select-none w-full flex flex-col items-center">
                <h2 className="text-[18vw] font-black uppercase tracking-[-0.05em] leading-none mb-[-1.5vw] text-accent">NICHE</h2>
                <h2 className="text-[18vw] font-black uppercase tracking-[-0.05em] leading-none text-accent">FORM</h2>
            </div>
            ...
            <div className="mt-8 sm:mt-12 md:mt-16 pt-6 sm:pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
                <p className="text-[8px] md:text-[10px] uppercase font-black tracking-[0.6em] md:tracking-[1em] text-accent/30 italic">
